  ...
  return (
    ...
    <div class="flex flex-row gap-3 pb-4">
        <div>
         ...
         <h1 class="text-3xl font-bold text-[#4B5563] text-[#4B5563] my-auto">TaskFlow</h1>

    </div>
    <div class="text-sm font-light text-[#6B7280] pb-8 ">Login to your account to Get Start.</div>
    <form class="flex flex-col">
        ...
        <button type="submit" class="w-full text-[#FFFFFF] bg-[#477fe6] focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mb-6">Login</button>
        <div class="text-sm font-light text-[#6B7280] ">Don't have an accout yet? <a href="#" class="font-medium text-[#477fe6] hover:underline">Sign Up</a>
